...
import { compareParticipantTimes, Participant, participantSpeed, participantTime, Penalty, readableReason } from "./participant";
...
export {
  ...
  Gender, PenaltyReason, ParticipantCategory,
  League, Flag, Trophy,
