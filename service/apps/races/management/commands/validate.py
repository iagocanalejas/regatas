...
from apps.races.services import TrophyService
...
def validate_file(file: str, manual: bool = False):
    ...
    errors = {
        ...
        # check null values
        'null_trophy': _check_null_values(dfs, COLUMN_NAME),
        ...
        'trophies_not_found': _check_trophies(dfs[COLUMN_NAME].unique()),
    }

    _check_trophies(dfs[COLUMN_TROPHY].unique())
