...
class LGTScrapper(Scrapper):
    _excluded_ids = [
        1, 2, 3, 4, 5, 6, 7, 8, 13, 14, 15, 23, 25, 26, 27, 28, 31, 32, 33, 34, 36, 37, 40, 41, 44, 50, 51, 54, 55, 56,
        57, 58, 59, 75, 88, 94, 95, 96, 97, 98, 99, 103, 104, 105, 106, 108, 125, 131, 137, 138, 147, 151
    ]  # weird races
    DATASOURCE: str = 'lgt'
    ...
    def scrap(self, race_id: int, **kwargs) -> List[ScrappedItem]:
        ...
        for row in soup.find('table', {'id': 'tabla-tempos'}).find_all('tr')[1:]:
            ...
            yield ScrappedItem(
                name=name, trophy_name=trophy_name, town=town, league=league, gender=None,
                organizer=organizer, edition=edition, day=day, t_date=t_date,
                ...
                race_id=str(race_id), url=url, datasource=self.DATASOURCE,
            )
