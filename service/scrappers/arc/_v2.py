...
from scrappers.arc.arc import ARCScrapper, ARC_V2
...
class ARCScrapperV2(ARCScrapper, version=ARC_V2):
            ...
            for table in tables:
                ...
                for result in results:
                    ...
                    yield ScrappedItem(
                        ...
                        series=series, lane=self.get_lane(result), laps=self.get_laps(result),
                        race_lanes=race_lanes, race_laps=race_laps, race_id=race_id, url=url,
    ...
    def get_race_details_soup(self, race_id: str, race_name: str = None, **kwargs) -> Tuple[Tag, str]:
        female = 'ligaete' if self._is_female else 'liga-arc'
